...
public class TimeConverterImpl implements TimeConverter {
     ...
     *
     * @param seconds - SS(Seconds) of HH:MM:SS
     */
     ...
     *
     * @param hours - HH(Hours) of HH:MM:SS
     */
     ...
     *
     * @param hours - remaining hours after first row.
     */
     ...
     *
     * @param minutes - MM(Minutes) of HH:MM:SS.
     */
	...
	/**
     * Converts the  remaining minutes of HH:MM:SS to equivalent second row of minutes.
     *
     * @param minutes - the remaining minutes after first row of minutes.
     */
     ...
     *
     * @param lamps - the number of lamps in a row.
     * @param lampValue - the value of a lamp in terms of hh/mm.
     * @param onLamps - The Lamp when HH/MM is there.
     * @param offLamp - The Lamp when HH/MM is zero.
     * @param time - the time to be used for printing BerlinClock.
     */
